...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String>{
    ...
    public void insert(NguoiHoc entity) {
        try {
            JdbcHelper.update(INSERT_SQL, entity.getMaNH(), entity.getHoTen(), entity.getNgaySinh(), entity.getGioiTinh(), entity.getDienThoai(),
    ...
    public void update(NguoiHoc entity) {
        try {
            JdbcHelper.update(UPDATE_SQL, entity.getHoTen(), entity.getNgaySinh(), entity.getGioiTinh(), entity.getDienThoai(),
