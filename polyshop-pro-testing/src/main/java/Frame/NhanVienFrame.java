...
public class NhanVienFrame extends javax.swing.JFrame {
        ...
        if(nv == null){
            ...
            if(!mk2.equals(nv.getMatKhau())){
                ...
                try{
                    ...
                    this.fillTable();
                    this.clearForm();
                    MsgBox.alert(this, "Đã thêm nhân viên mới thành công!");
                }catch(Exception e){
        ...
        if(nv == null){
            ...
            if(!mk2.equals(nv.getMatKhau())){
                ...
                try{
                    dao.update(nv);
                    this.fillTable();
                    MsgBox.alert(this, "Đã cập nhật thông tin nhân viên thành công!");
                }catch(Exception e){
    ...
    boolean Validation(){
        ...
        if(txtMaNV.getText().length() == 0){
            ...
            MsgBox.alert(this, "Mã nhân viên không vượt quá 50 ký tự!");
            txtMaNV.setFocusable(true);
            return false;
        }
        ...
        if(txtHoTen.getText().length() == 0){
            MsgBox.alert(this, "Bạn chưa nhập họ tên cho nhân viên!");
        ...
        if(txtMatKhau.getText().length() == 0){
            MsgBox.alert(this, "Bạn chưa nhập mật khẩu cho nhân viên!");
        ...
        if(txtXacNhanMK.getText().length() == 0){
            MsgBox.alert(this, "Bạn chưa nhập xác nhận mật khẩu cho nhân viên!");
